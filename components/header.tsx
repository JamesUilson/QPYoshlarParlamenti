    ...
    <header className="w-full shadow-sm sticky top-0 z-40">
      ...
      <div className="bg-[#0047AB]">
        ...
        <div className="lg:hidden flex items-center justify-between px-4 py-2">
          <span className="text-white text-sm font-medium">Menyu</span>
